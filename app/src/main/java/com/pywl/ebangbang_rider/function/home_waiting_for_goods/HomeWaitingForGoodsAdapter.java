 ...
 */
public class HomeWaitingForGoodsAdapter extends BaseQuickAdapter<HomeWaitingForGoodsEntity.DataBean, BaseViewHolder> {

    private Context mContext;

    public HomeWaitingForGoodsAdapter(int layoutResId, @Nullable List<HomeWaitingForGoodsEntity.DataBean> data, Context context) {
