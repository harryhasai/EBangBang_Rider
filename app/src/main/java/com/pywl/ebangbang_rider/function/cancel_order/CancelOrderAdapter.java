 ...
 */
public class CancelOrderAdapter extends BaseQuickAdapter<HomeWaitingForGoodsEntity.DataBean, BaseViewHolder> {

    private Context mContext;

    public CancelOrderAdapter(int layoutResId, @Nullable List<HomeWaitingForGoodsEntity.DataBean> data, Context context) {
