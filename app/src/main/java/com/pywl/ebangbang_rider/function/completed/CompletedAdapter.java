 ...
 */
public class CompletedAdapter extends BaseQuickAdapter<HomeWaitingForGoodsEntity.DataBean, BaseViewHolder> {

    private Context mContext;

    public CompletedAdapter(int layoutResId, @Nullable List<HomeWaitingForGoodsEntity.DataBean> data, Context context) {
